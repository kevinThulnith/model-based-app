...
![Google](https://img.shields.io/badge/Google_Sign--In-4285F4?logo=google&logoColor=white)
...
SEDI is a cutting-edge mobile health application that leverages advanced machine learning models to predict three major health conditions:

- **🩸 Diabetes** - Risk assessment based on lifestyle and metabolic factors
- **❤️ Heart Disease** - Prediction using clinical measurements and cardiovascular indicators
- **🫘 Chronic Kidney Disease** - Detection based on lab results and clinical parameters

The application combines a **Flutter-based cross-platform mobile frontend** with a **Django REST API backend** that serves trained ML models for real-time health predictions. Get instant health insights powered by AI! 🔬✨
...
- ⚡ Fast predictions with optimized models
...
- **UI Libraries**: Google Fonts ✍️, Flutter Animate 🎬, Shimmer ✨
...
│   ├── backend/ ⚙️              # Django project settings
│   │   ├── settings.py 🔧       # Configuration
│   │   └── urls.py 🌐           # Main URL config
│   ├── diabetes/ 🩸             # Diabetes model files
│   ├── heart disease/ ❤️        # Heart disease model files
...
3. **🔥 Configure Firebase**
   ...
   - Update `firebase.json` with your project settings ⚙️
...
| `/api/heart-disease/`          | POST   | ❤️ Predict heart disease                |
...
### 2. ❤️ Heart Disease Prediction Model
